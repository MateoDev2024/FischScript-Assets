...
-- Decompiled on 2025-01-24 07:03:04
-- Luau version 6, Types version 3
-- Time taken: 0.276803 seconds
...
function module_upvr.ToInteger(arg1, arg2) -- Line 8342
	return math.floor(arg2.r * 255) * 65536 + math.floor(arg2.g * 255) * 256 + math.floor(arg2.b * 255)
end
function module_upvr.ToHex(arg1, arg2) -- Line 8346
	--[[ Upvalues[1]:
	...
	local var1836
	repeat
		local var1837 = any_ToInteger_result1 % 16
		local tostring_result1 = tostring(var1837)
		if 10 <= var1837 then
			tostring_result1 = ({'A', 'B', 'C', 'D', 'E', 'F'})[1 + var1837 - 10]
		end
		var1836 = var1836..tostring_result1
	until math.floor(any_ToInteger_result1 / 16) <= 0
	return '#'..string.reverse(var1836)
end
return module_upvr
