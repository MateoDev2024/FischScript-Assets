...
v_u_4["Red Energy Crystal"] = v5
v_u_4["Green Energy Crystal"] = {
	["WeightPool"] = { 25, 50 },
	["Chance"] = 0.001,
	["Rarity"] = "Mythical",
	["Resilience"] = 100,
...
v_u_4.Bone = {
	["WeightPool"] = { 10, 25 },
	["Chance"] = 100 * v3["Brine Pool"].Trash,
	["Rarity"] = "Trash",
	["Resilience"] = 80,
...
v_u_4.Stalactite = {
	["WeightPool"] = { 60, 130 },
	["Chance"] = 100 * v3["Desolate Deep"].Trash,
	["Rarity"] = "Trash",
	["Resilience"] = 80,
...
function v_u_4.ToInteger(_, p6)
	local v7 = p6.r * 255
	local v8 = math.floor(v7) * 65536
	local v9 = p6.g * 255
	local v10 = v8 + math.floor(v9) * 256
	local v11 = p6.b * 255
	return v10 + math.floor(v11)
end
function v_u_4.ToHex(_, p12)
	-- upvalues: (copy) v_u_4
	local v13 = v_u_4:ToInteger(p12)
	local v14 = {
		"A",
		"B",
		"C",
