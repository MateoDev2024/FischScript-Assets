...
-- Decompiled on 2024-12-21 07:45:37
...
function module_upvr.ToInteger(arg1, arg2) -- Line 7226
	return math.floor(arg2.r * 255) * 65536 + math.floor(arg2.g * 255) * 256 + math.floor(arg2.b * 255)
end
function module_upvr.ToHex(arg1, arg2) -- Line 7230
	--[[ Upvalues[1]:
	...
	local var1664
	repeat
		local var1665 = any_ToInteger_result1 % 16
		local tostring_result1 = tostring(var1665)
		if 10 <= var1665 then
			tostring_result1 = ({'A', 'B', 'C', 'D', 'E', 'F'})[1 + var1665 - 10]
		end
		var1664 = var1664..tostring_result1
	until math.floor(any_ToInteger_result1 / 16) <= 0
	return '#'..string.reverse(var1664)
end
return module_upvr
