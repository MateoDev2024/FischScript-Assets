...
-- Decompiled on 2025-03-01 08:06:15
-- Luau version 6, Types version 3
-- Time taken: 0.350808 seconds

local longstring1 = "An immortal stone filled with the essence of a Divine Lantern Keeper.. Returning it to it's throne under the Statue of Sovereignty will result in your currently equipped rod being blessed with its immense power."
...
local module_2_upvr = {
	...
	["Baby Pond Emperor"] = {
		...
		Seasons = {"Summer"};
		Weather = {"None"};
		Quips = {"Woah! a Baby Pond Emperor!", "A Baby Pond Emperor..?"};
		SparkleColor = Color3.fromRGB(255, 227, 15);
		HoldAnimation = fish:WaitForChild("small");
		From = "Ocean";
	};
...
function module_2_upvr.ToInteger(arg1, arg2) -- Line 11026
	return math.floor(arg2.r * 255) * 65536 + math.floor(arg2.g * 255) * 256 + math.floor(arg2.b * 255)
end
function module_2_upvr.ToHex(arg1, arg2) -- Line 11030
	--[[ Upvalues[1]:
	...
	local var2470
	repeat
		local var2471 = any_ToInteger_result1 % 16
		local tostring_result1 = tostring(var2471)
		if 10 <= var2471 then
			tostring_result1 = ({'A', 'B', 'C', 'D', 'E', 'F'})[1 + var2471 - 10]
		end
		var2470 = var2470..tostring_result1
	until math.floor(any_ToInteger_result1 / 16) <= 0
	return '#'..string.reverse(var2470)
end
